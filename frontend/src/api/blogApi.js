...
export const blogApi = {
  /** @param {object} req - {company_name, url, market, industry, count} */
  suggestTopics: (req) => post("/blog/suggest-topics", req),
  /** @param {object} req - {company_name, url, market, industry, topic, target_keyword} */
  generate: (req) => post("/blog/generate", req),
};
